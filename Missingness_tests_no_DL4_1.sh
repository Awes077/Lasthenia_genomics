...
#ipyrad -p params-Lasthenia_L1R2.txt -b Lasthenia_L1R2_no_DL4_1 - DL4_1

#ipyrad -p params-Lasthenia_L1R2_no_DL4_1.txt -s 12 -c ${SLURM_NTASKS} -f

#create branches for one mismatch and two mismatches with barcode 
#ipyrad -p params-Lasthenia_L1R2_no_DL4_1.txt -b clust90 -f
#sed -i '/\[14] /c\0.9 ## [14]' params-clust90.txt
#ipyrad -p params-Lasthenia_L1R2_no_DL4_1.txt -b clust92 -f
#sed -i '/\[14] /c\0.92 ## [14]' params-clust92.txt
#ipyrad -p params-Lasthenia_L1R2_no_DL4_1.txt -b clust94 -f
#sed -i '/\[14] /c\0.94 ## [14]' params-clust94.txt
#ipyrad -b clust96 -p params-Lasthenia_L1R2_no_DL4_1.txt -f
#sed -i '/\[14] /c\0.96 ## [14]' params-clust96.txt
#ipyrad -b clust98 -p params-Lasthenia_L1R2_no_DL4_1.txt -f
