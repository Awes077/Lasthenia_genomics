...
#SBATCH --job-name=Cluster_threshold_test
#SBATCH --output Multi_clust_thresh_assembly.txt
...
perl vcfMissingness.pl --vcflist vcf_list.txt

Rscript vcfToPCAvarExplained.R vcf_list.txt 4
